...
const CombinationOrderModal = ({ open, handleClose, combination }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const transformedData = combination.map((service) => ({
      service: service,
      quantity: 1,
      price: service.price,
    }));

    const totalPrice = combination.reduce((acc, service) => acc + service.price, 0);
